...
const HeroSection: FC = () => {
  ...
  // Example: If you use Date.now() or Math.random() for animation or display
  // Replace this:
  // const now = Date.now();
  // With this:
