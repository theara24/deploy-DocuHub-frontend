...
export default function BrowsePage() {
  ...
  const filteredResults = useMemo(() => {
    console.log('Filtering with query:', searchQuery, 'category:', selectedCategory);
  ...
  }, [searchQuery, selectedCategory, t, searchResults]);
                ...
                <div className="space-y-6">
                  {filteredResults.map((result) => (
                      ...
                      <HorizontalCard
                          ...
                          paperId={result.id.toString()} // This is now valid
                          onDownloadPDF={() => console.log('Download PDF:', result.id)}
